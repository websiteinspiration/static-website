          ...
          <FlexWrapper>
            ...
            <TextContent>
              <p>
                ...
                as The Women’s March highlighting equal rights’ injustices
                around the globe. At Honeypot, we are committed to actively
                promoting women in tech. With the gender wage gap widely
                reported as affecting women across the world, we decided to
                research the specific role that gender parity plays in the
                technology landscape. In sharing this study, we aim to highlight
                the barriers and opportunities for women in the IT industry.
              </p>
              ...
              <ul>
                ...
                <li>
                  ...
                  women in the general workforce, and the percentage of women in
                  the technology sector. In addition, the study took into
              ...
              <p>
                ...
                participation to conclude overall parity. To determine if
                equality has increased or decreased in recent history, we then
                calculated the difference between the gender pay gap five years
                ago, as compared to today’s wage gap.
              </p>

              <p>
                {' '}
                &nbsp;&nbsp;&nbsp;&nbsp; “Gender parity in the workplace is not
                just an ethical or moral issue, but also an economic one:
                McKinsey found that $12 trillion could be added to global GDP by
                2025 by advancing women’s equality. As tech recruitment
                specialists, we are often confronted with the gender imbalances
                of the industry, which are fully exposed in this study.” says
                Emma Tracey, Co-Founder at Honeypot. “The results reveal the
                countries which have the most to offer women looking to progress
                in the tech industry, with Portugal, The United States and
                Latvia highlighted as the top three nations that have taken
                positive steps towards gender parity in the technology field in
                terms of fairer wages. However, with the proportion of female
                tech workers remaining under 30% across the board, we hope that
                this study will enrich the conversation concerning equality in
                this industry and inspire more women to seek out opportunities
                in tech.”
              </p>

              <p>
                The table below is ranked in order to show which countries offer
                the best opportunity for women in tech by comparing the
                difference between the overall gender pay gap and the pay gap in
                the technology industry. A positive number demonstrates that
                income disparity in tech is less than the overall average in
                that country, indicating that female tech workers have been
              ...
              <ul>
                ...
                <li>
                  ...
                  <strong>
                    ...
                    legislators, senior officials and managers (%): Major Group
                ...
                <li>
                  ...
                  Some overlap between ministers and heads of state that also
                  hold a ministerial portfolio may occur.{' '}
                  <strong>
                    Source: The Inter-Parliamentary Union, Women in Politics
                    2015, reflecting appointments up to 1 January 2015. Data is
                ...
                <li>
                  ...
                  women and the percentage difference between them, known as the
                  Gender Pay Gap.{' '}
                  <em>
                    ...
                    men. Data refers to full-time employees and to self-employed
                    workers.
                  </em>
                </li>
                ...
                <li>
                  ...
                  activities, including software publishing (division 58),
                  motion picture and sound recording activities (division 59),
                  radio and TV broadcasting and programming activities (division
                  60), telecommunications activities (division 61) and
                  information technology activities (division 62) and other
                ...
                <li>
                  ...
                  women in the information and communication technology sector
                ...
                <li>
                  <strong>Tech Average Wage (US$):</strong> Average annual wage
                  in ICT (as defined above). Annual in USD PPP (Purchasing power
                ...
                <li>
                  ...
                  (Purchasing power parities), taking into account the wage gap
                  in ICT and average wage in ICT.{' '}
                ...
                <li>
                  ...
                  (as defined above), data from 2010. In the case of Chile: 2011
                ...
                <li>
                  ...
                  years ago. A positive number implies a positive increase, I.E.
                  the gender pay gap has increased. A negative number implies
                  that the gender pay gap has decreased.
                </li>
              </ul>
            </TextContent>
          </FlexWrapper>
